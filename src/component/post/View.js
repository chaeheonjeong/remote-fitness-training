      ...
      <div className={styles.detail}>
        <div className={styles.content_4}>
          <div className={styles.content_4_a}>
            <div>
              <button className={progress ? styles.falseBtn : styles.cbtn}>
                {progress ? "모집완료" : "모집중"}
              </button>
            </div>
          </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className={styles.content_6}>
          ...
          <div className={styles.reply_choose}>
            <text className={isSecret ? styles.falseSecret : styles.trueSecret}>
              비밀댓글: {isSecret ? "체크됨" : "체크안됨"}
            </text>
                      ...
                      <div className={styles.rhandle}>
                        ...
                        <div className={styles.reply_choose}>
                          <input
                            ...
                            checked={isRSecret}
                            className={styles.secret}
                            onChange={(e) => setIsRSecret(e.target.checked)}
                          ></input>
