...
const TViewReply = ({ write, setWrite }) => {
    ...
    useEffect(() => {
        ...
        try {
            ...
            .get(`http://localhost:8080/getTReply/${id}`, {
    ...
    const fetchR_Reply = async (rid) => {
        try {
          const res = await axios
            .get(`http://localhost:8080/getTR_Reply/${id}/${rid}`, {
              headers: { Authorization: `Bearer ${user.token}` },
            });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
        const response = await axios.post(`http://localhost:8080/postTreply/${id}`, {
    ...
    const rhandleSubmit = async (e) => {
        ...
        console.log(data);
        try {
        const response = await axios.post(`http://localhost:8080/postTr_reply/${id}/${selectedRId}`, {
    ...
    const handleRDelete = async (rrid) => {
        ...
        if(confirmRDelete) {
        try {
            const response = await axios.delete(`http://localhost:8080/postTr_reply/${id}/${selectedRId}/${rrid}`, {
            headers: { Authorization: `Bearer ${user.token}` },
            });
    ...
    const modifyRHandleSubmit = async (e, selectedRId, rrid) => {
        ...
        try {
        const response = await axios.post("http://localhost:8080/viewTReplyRModify", {
            postRId: id,
    ...
    const modifyR_Reply = async (rrid) => {
        try {
        const res = await axios
        .get(`http://localhost:8080/tView/${id}/modify/${selectedRId}/${rrid}`)
    ...
    const modifyHandleSubmit = async (e, replyId) => {
        ...
        try {
        const response = await axios.post("http://localhost:8080/viewTReplyModify", {
            postId: id,
            _id: replyId,
            rWriteDate: today,
    ...
    const modifyReply = async (replyId) => {
        try {
        const res = await axios
        .get(`http://localhost:8080/tView/${id}/modify/${replyId}`)
